...
async def parseCustomStuff (gameCrafterSession):
    ...
    for component in productInfo:
        ...
        # TODO This upload task isn't mapped correctly.
        ...
        # TODO this was reset 
        componentInfo[varname]["HasPieceQuantity"] = True
        componentInfo[varname]["ArtDataTypeNames"] = ardataTypes
    ...
    with open('./customComponents.json', 'w') as f:
        json.dump(componentInfo, f, indent=2)
